...
from primewire import Primewire
...
class Crawler:
    ...
    def crawl_flw_item(
        ...
        try:
            ...
            # with open("json/crawled-movie.json", "w") as f:
            #     f.write(json.dumps(film_data, indent=4, ensure_ascii=False))

            # sys.exit(0)
            Primewire(film=film_data, episodes=episodes_data).insert_film()
...
if __name__ == "__main__":
    Crawler().crawl_page(url=CONFIG.TINYZONETV_TVSHOWS_PAGE + "?page=50")
